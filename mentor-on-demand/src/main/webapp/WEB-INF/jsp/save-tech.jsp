...
<head>
	<meta charset="UTF-8">
	<title>Admin - Save Technology</title>
...
<body>
	<div class="outer">
		...
		<div class="main1">
			...
			<h2 style="margin:0px;">Add Technology</h2>
			<div class="list">
				<div class="item">
					<table align="center" width="40%" cellpadding="2">
						<form:form method="post" action="save-tech" onsubmit="save()" autocomplete="off">
						<tr>
							<td>Technology : </td>
							<td><form:input path="technologyName" placeholder="Technology Name" required="true"/></td>
						</tr>
						<tr>
							<td colspan="2"><form:hidden  path="isActive" readonly="true" value="1" /></td>
						</tr>
						<tr>
